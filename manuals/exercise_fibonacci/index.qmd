---
title: "Fibonnacci Sequence -- Last Digits"
description: "Julia, Exercise"
image: image.png
...
You solved the problem? Great! To see one possible solution, compute the last digits for `n = [87883, 22078, 65144, 42513, 99380, 98764]` and append these digits in the given order to your browser's URL, add `.html` and hit {{< kbd Enter >}}.
