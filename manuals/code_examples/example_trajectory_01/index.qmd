...
Next, the locally available ExESS package has to be loaded to access the `trajectory` function (see the [API](/api/exospheres/trajectory.qmd) page for details):
```{julia}
#| output: false
