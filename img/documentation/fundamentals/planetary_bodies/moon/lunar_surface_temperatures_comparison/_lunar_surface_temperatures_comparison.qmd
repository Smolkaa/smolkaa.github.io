...
![Statistical temperature difference mean.](/img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_mean.svg){#fig-lunar-surface-temperatures-comparison-mean}

![Root mean squared error of temperature differences.](/img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_rms.svg){#fig-lunar-surface-temperatures-comparison-rms}
...
* {{< downloadthis ../../img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_mean.pdf label="mean.pdf" type="light" dname="mean" >}} {{< downloadthis ../../img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_mean.svg label="mean.svg" type="light" dname="mean" >}} {{< downloadthis ../../img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_mean.png label="mean.png" type="light" dname="mean" >}}

* {{< downloadthis ../../img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_rms.pdf label="rms.pdf" type="light" dname="rms" >}} {{< downloadthis ../../img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_rms.svg label="rms.svg" type="light" dname="rms" >}} {{< downloadthis ../../img/documentation/fundamentals/planetary_bodies/moon/lunar_surface_temperatures_comparison/temperature_comparison_rms.png label="rms.png" type="light" dname="rms" >}}
