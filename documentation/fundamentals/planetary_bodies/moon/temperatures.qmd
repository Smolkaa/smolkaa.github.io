---
title: "3.1.1.1 - Lunar Temperatures"
...
The two presented analytical models of the lunar surface temperatures have been compared with the averaged \gls{DLRE} measurements. Figure~\ref{fig:lunar_surface_temperatures_comparison} shows this statistical analysis of the temperatures difference of the @Butler1997 and @Hurley2015 calculated as $\Delta\temperature_i = \temperature_i - \temperature_\text{Diviner}$ for each analytical model $i$, evaluated on \SI{270e3}{} surface points, globally distributed using the \gls{HEALPix} method. 
