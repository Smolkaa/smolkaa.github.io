---
title: "Exospheric Density Projections"
format:
  html: default
---
...
@Chamberlain1963 derived a model for the exospheric particle number density $\numberDensity\left(\radius\right)$ as a function of the radial distance from the center of the planetary body, based on the assumption of a hydrostatic equilibrium and a Maxwellian velocity distribution, see section [Velocity Distributions](/documentation/fundamentals/velocity_distributions.qmd): 
\begin{equation}
