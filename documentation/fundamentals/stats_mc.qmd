...
The expected value of the entire system can be calculated as the empirical average of all [independent and identically distributed (IID)](/documentation/acronyms.qmd) samples $\{\sample_1, \sample_2, \dots, \sample_N\}$:
\begin{equation}
