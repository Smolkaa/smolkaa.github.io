...
\end{tikzpicture}
```
Note that the code above requires the `TikZ` package alongside the `positioning` and `shadows` libraries. Additionally, the variables like `\sample` need to be defined in the preamble (i.e. $\newcommand{\sample}{X}$).
