...
{{< include /documentation/fundamentals/velocity_distributions/tables/mbfd_typical_speeds/raw_mbfd_typical_speeds.md >}}

: Overview of normalized speeds $\velocity$ of the [MBFD](/documentation/acronyms.qmd), according to Eq. \refeq{eq:mbfd_speed}, including a comparison with its typical speeds, the most probable speed, $\velocity_p$, the mean speed, $\meanof{\velocity}$, and the root mean squared speed, $\velocity_\text{rms}$. {#tbl-mbfd_typical_speeds .hover}
...
* {{< downloadthis velocity_distributions/tables/mbfd_typical_speeds/raw_mbfd_typical_speeds.md label="raw.md" type="light" dname="table" >}}
