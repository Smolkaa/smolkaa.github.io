...
::: {#fig-ls3dgrid layout-ncol=2}
![Regular vertical spacing.](/documentation/fundamentals/numerical_grids/imgs/ls3dgrid/ls3dgrid.svg){#fig-ls3dgrid_regular width="600px"}

![Exponential vertical spacing.](/documentation/fundamentals/numerical_grids/imgs/ls3dgrid/ls3dgrid_exp.svg){#fig-ls3dgrid_exponential width="600px"}

Exemplary local structured 3D grid of a cube with a total of $5 \times 2 \times 7$ elements in $\cartesianCoordinateX$, $\cartesianCoordinateY$, and $\cartesianCoordinateZ$ direction. 
:::
...
* {{< downloadthis numerical_grids/imgs/ls3dgrid/ls3dgrid.pdf label="regular.pdf" type="light" dname="regular" >}} {{< downloadthis numerical_grids/imgs/ls3dgrid/ls3dgrid.svg label="regular.svg" type="light" dname="regular" >}} {{< downloadthis numerical_grids/imgs/ls3dgrid/ls3dgrid.png label="regular.png" type="light" dname="regular" >}} 

* {{< downloadthis numerical_grids/imgs/ls3dgrid/ls3dgrid_exp.pdf label="exponential.pdf" type="light" dname="exponential" >}} {{< downloadthis numerical_grids/imgs/ls3dgrid/ls3dgrid_exp.svg label="exponential.svg" type="light" dname="exponential" >}} {{< downloadthis numerical_grids/imgs/ls3dgrid/ls3dgrid_exp.png label="exponential.png" type="light" dname="exponential" >}} 
:::