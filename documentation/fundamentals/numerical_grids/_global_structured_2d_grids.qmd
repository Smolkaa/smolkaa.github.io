...
::: {.column-margin}
{{< fa code >}} [`coords`](/api/grids/utility.qmd): Eqs. \eqref{eq:gs2dgrid_azimuth}, \eqref{eq:gs2dgrid_elevation} </br> {{< fa code >}} [`surfacecoords`](/api/grids/utility.qmd): identical to `coords`
:::
...
::: {.column-margin}
{{< fa code >}} [`areas`](/api/grids/utility.qmd): Eq. \eqref{eq:area_gs2dgrid}
:::
...
::: {.column-margin}
{{< fa code >}} [`GlobalStructuredGrid_EqSim`](/api/grids/global_structured_2d_grids.qmd) Eqs. \eqref{eq:gs2dgrid_eqsim_elevation} - \eqref{eq:gs2dgrid_eqsim_coord2idx_elevation} </br>
{{< fa code >}} [`areas`](/api/grids/utility.qmd): Eq. \eqref{eq:area_gs2dgrid} </br>
{{< fa code >}} [`coords`](/api/grids/utility.qmd): Eqs. \eqref{eq:gs2dgrid_azimuth}, \eqref{eq:gs2dgrid_eqsim_elevation} </br>
{{< fa code >}} [`coord2idx`](/api/grids/utility.qmd): Eqs. \eqref{eq:gs2dgrid_coord2idx_azimuth}, \eqref{eq:gs2dgrid_eqsim_coord2idx_elevation}
:::