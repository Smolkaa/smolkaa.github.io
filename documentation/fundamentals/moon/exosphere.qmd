...
@Chamberlain1963 derived a model for the exospheric particle number density $\numberDensity\left(\radius\right)$ as a function of the radial distance from the center of the planetary body, based on the assumption of hydrostatic equilibrium and a Maxwellian velocity distribution, see section [Velocity Distributions](/documentation/drivers/thermal_sorption.qmd#sec-velocity-distributions): 
\begin{equation}
...
\begin{align}
    ...
    \label{eq:chamberlain_partition_function}
\end{align}
...
::: {.callout-note title="PDS Atmospheres"}
{{< fa link >}} [pds-atmospheres.nmsu.edu](https://pds-atmospheres.nmsu.edu/ data_and_services/atmospheres_data/LADEE/mainr.html) _(last visited: May 2023)_
:::


{{< include imgs/ladee_n0/_ladee_n0.qmd >}}
...
{{< include tbls/_H2.qmd >}}

### Helium -- $\ce{He}$
{{< include tbls/_He.qmd >}}

### Hydroxyl -- $\ce{OH}$
{{< include tbls/_OH.qmd >}}

### Water -- $\ce{H2O}$
{{< include tbls/_H2O.qmd >}}

### Neon -- $\ce{Ne}$
{{< include tbls/_Ne.qmd >}}
...
* Function: [`projection_CHAMBERLAIN1963`](/api/exospheres/utility.qmd). Projects the number densities from one altitude to another using the model by @Chamberlain1963. See Eqs. \eqref{eq:chamberlain_projection} and \eqref{eq:chamberlain_partition_function} for details.