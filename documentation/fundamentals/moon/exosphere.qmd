...
* Function: [`projection_CHAMBERLAIN1963`](/api/exospheres/utility.qmd). Projects the number densities from one altitude to another using the model by @Chamberlain1963.