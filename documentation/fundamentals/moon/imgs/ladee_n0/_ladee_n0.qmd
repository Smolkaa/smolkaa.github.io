...
![Helium surface number densities.](/documentation/fundamentals/moon/imgs/ladee_n0/ladee_n0_He_proj.png){#fig-ladee-n0-he width="1200px"}

![Neon surface number densities.](/documentation/fundamentals/moon/imgs/ladee_n0/ladee_n0_Ne_proj.png){#fig-ladee-n0-ne width="1200px"}

![Argon surface number densities.](/documentation/fundamentals/moon/imgs/ladee_n0/ladee_n0_Ar_proj.png){#fig-ladee-n0-ar width="1200px"}
...
* {{< downloadthis moon/imgs/ladee_n0/ladee_n0_He_proj.png label="LADEE_n0_Helium.png" type="light" dname="LADEE_n0_Helium" >}} 

* {{< downloadthis moon/imgs/ladee_n0/ladee_n0_Ne_proj.png label="LADEE_n0_Neon.png" type="light" dname="LADEE_n0_Neon" >}} 

* {{< downloadthis moon/imgs/ladee_n0/ladee_n0_Ar_proj.png label="LADEE_n0_Argon.png" type="light" dname="LADEE_n0_Argon" >}} 
