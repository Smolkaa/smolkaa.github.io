...
\begin{equation}
    \temperature (\longitude_{ss}, \latitude_{ss}) = \begin{cases}
        \SI{262}{\kelvin} \cdot \cos^{1/2} \left( \zenith_s \right) + \SI{130}{\kelvin}, \qquad & \text{ if } \left|\longitude_{ss}\right| < \SI{90}{\degree}, \\
