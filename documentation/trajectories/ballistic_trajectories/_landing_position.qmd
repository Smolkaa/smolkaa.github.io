...
{{< bi code >}} [`landing_position`](/api/exospheres/landing_position.qmd)
:::
...
\end{equation}
with the gravitational constant $\GravitationalConstant$, the central body's mass $\mass$, and the radial distance of its center of mass $\radius$, the relative kinetic energy fraction
\begin{equation}
