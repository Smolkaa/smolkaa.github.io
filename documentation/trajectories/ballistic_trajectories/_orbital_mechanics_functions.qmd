...
\end{equation} 
[{{< bi code >}} [`azimuth_angle_v`](/api/exospheres/orbital_mechanics.qmd): $\azimuth\left(\vec\velocity\right)$: Eq. \eqref{eq:azimuth_angle_v}]{.aside}
