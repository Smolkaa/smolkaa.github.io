...
The azimuth angle $\azimuthAngle$, measured mathematically positive from $\cartesianCoordinateX`, i.e., north from east, can be calculated using the following multi-case definition:
\begin{equation}
