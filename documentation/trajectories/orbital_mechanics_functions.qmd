---
title: "4.2 Orbital Mechanics Functions"
format:
  html: default
---
...
For additional background information and the theory behind gravitational potential fields, as well as gravitational forces, see the [Gravitational Potential](/documentation/trajectories//gravitational_potential.qmd) section.
...
\end{equation} 
[{{< fa code >}} [`azimuth_angle_v`](/api/exospheres/orbital_mechanics.qmd): $\azimuthAngle\left(\vec\velocity\right)$: Eq. \eqref{eq:azimuth_angle_v}]{.aside}
...
\end{equation}
[{{< fa code >}} [`eccentric_anomaly_e_theta`](/api/exospheres/orbital_mechanics.qmd): $\eccentricAnomaly\left(\eccentricity, \trueAnomaly\right)$: Eq. \eqref{eq:eccentric_anomaly_e_theta} </br> {{< fa code >}} [`eccentric_anomaly_e_M`](/api/exospheres/orbital_mechanics.qmd): $\eccentricAnomaly\left(\eccentricity, \meanAnomaly\right)$: Eq. \eqref{eq:eccentric_anomaly_e_M}]{.aside}
...
::: {.column-margin}
{{< fa code >}} [`eccentricity_epskin_psi`](/api/exospheres/orbital_mechanics.qmd): $\eccentricity\left(\relativeKineticEnergy, \zenithAngle\right)$: Eq. \eqref{eq:eccentricity_epskin_psi}  

{{< fa code >}} [`eccentricity_epskin_v`](/api/exospheres/orbital_mechanics.qmd): $\eccentricity\left(\relativeKineticEnergy, \vec\velocity\right)$: Eq. \eqref{eq:eccentricity_epskin_psi} with $\velocity=\velocity(\zenithAngle)$ from Eq. \eqref{eq:zenith_angle_v}

{{< fa code >}} [`eccentricity_r_m_v`](/api/exospheres/orbital_mechanics.qmd): $\eccentricity\left(\radius, \mass, \velocity\right)$: Eq. \eqref{eq:eccentricity_epskin_psi} with $\relativeKineticEnergy=\relativeKineticEnergy\left(\velocity_{esc}(\radius,\mass),\velocity\right)$ from Eqs. \eqref{eq:escape_velocity_r_m} and \eqref{eq:relative_Ekin_v_vesc}, and with $\velocity=\velocity(\zenithAngle)$ from Eq. \eqref{eq:zenith_angle_v}
:::
...
::: {.column-margin}
{{< fa code >}}  [`escape_velocity_r_m`](/api/exospheres/orbital_mechanics.qmd): $\velocity_{esc}\left(\radius, \mass\right)$: Eq. \eqref{eq:escape_velocity_r_m} 
:::
...
::: {.column-margin}
{{< fa code >}} [`ground_distance_R_dtheta`](/api/exospheres/orbital_mechanics.qmd): $\distance\left(\radius, \trueAnomaly\right)$: Eq. \eqref{eq:ground_track_distance_r_dtheta}  

{{< fa code >}} [`ground_distance_R_a_e`](/api/exospheres/orbital_mechanics.qmd): $\distance\left(\radius, \semiMajorAxis, \eccentricity\right)$: Eq. \eqref{eq:ground_track_distance_r_dtheta} with $\Delta\trueAnomaly = 2\pi - 2\trueAnomaly$ and $\trueAnomaly = \trueAnomaly\left(\radius, \semiMajorAxis, \eccentricity\right)$ of Eq. \eqref{eq:true_anomaly_r_a_e}
:::
...
::: {.column-margin}
{{< fa code >}} [`mean_anomaly_e_E`](/api/exospheres/orbital_mechanics.qmd): $\meanAnomaly\left(\eccentricity, \eccentricAnomaly\right)$: Eq. \eqref{eq:mean_anomaly_e_E}  

{{< fa code >}} [`mean_anomaly_e_theta`](/api/exospheres/orbital_mechanics.qmd): $\meanAnomaly\left(\eccentricity, \trueAnomaly\right)$: Eq. \eqref{eq:mean_anomaly_e_E} with $\eccentricAnomaly=\eccentricAnomaly(\eccentricity, \trueAnomaly)$ from Eq. \eqref{eq:eccentric_anomaly_e_theta}
:::
...
::: {.column-margin}
{{< fa code >}} [`orbit_period_a_m`](/api/exospheres/orbital_mechanics.qmd): $\period\left(\semiMajorAxis, \mass\right)$: Eq. \eqref{eq:orbit_period_a_m}  
:::
...
::: {.column-margin}
{{< fa code >}} [`orbit_time_M_P`](/api/exospheres/orbital_mechanics.qmd): $\Time\left(\meanAnomaly, \period\right)$: Eq. \eqref{eq:orbit_time_M_P}  

{{< fa code >}} [`orbit_time_e_E_P`](/api/exospheres/orbital_mechanics.qmd): $\Time\left(\eccentricity, \eccentricAnomaly, \period\right)$: Eq. \eqref{eq:orbit_time_M_P} with $\meanAnomaly = \meanAnomaly(\eccentricity, \eccentricAnomaly)$ of Eq. \eqref{eq:mean_anomaly_e_E}

{{< fa code >}} [`orbit_time_e_theta_P`](/api/exospheres/orbital_mechanics.qmd): $\Time\left(\eccentricity, \trueAnomaly, \period\right)$: Eq. \eqref{eq:orbit_time_M_P} with $\meanAnomaly = \meanAnomaly(\eccentricity, \eccentricAnomaly)$ of Eq. \eqref{eq:mean_anomaly_e_E} and $\eccentricAnomaly = \eccentricAnomaly\left(\eccentricity, \trueAnomaly\right)$ of Eq. \eqref{eq:eccentric_anomaly_e_theta}
:::
...
::: {.column-margin}
{{< fa code >}} [`epskin_vesc_v`](/api/exospheres/orbital_mechanics.qmd): $\relativeKineticEnergy\left(\vec\velocity, \velocity_{esc}\right)$: Eq. \eqref{eq:relative_Ekin_v_vesc}  

{{< fa code >}} [`epskin_r_m_v`](/api/exospheres/orbital_mechanics.qmd): $\relativeKineticEnergy\left(\radius, \mass, \vec\velocity\right)$: Eq. \eqref{eq:relative_Ekin_v_vesc} with $\velocity_{esc} = \velocity_{esc}\left(\radius, \mass\right)$ of Eq. \eqref{eq:escape_velocity_r_m}

{{< fa code >}} [`epskin_r_a`](/api/exospheres/orbital_mechanics.qmd): $\relativeKineticEnergy\left(\radius, \semiMajorAxis\right)$: Eq. \eqref{eq:relative_Ekin_r_a}

{{< fa code >}} [`epskin_e_theta`](/api/exospheres/orbital_mechanics.qmd): $\relativeKineticEnergy\left(\eccentricity, \trueAnomaly\right)$: Eq. \eqref{eq:relative_Ekin_e_theta}
:::
...
::: {.column-margin}
{{< fa code >}} [`semi_latus_rectum_a_e`](/api/exospheres/orbital_mechanics.qmd): $\semiLatusRectum\left(\semiMajorAxis, \eccentricity\right)$: Eq. \eqref{eq:semi_latus_rectum_a_e}  

{{< fa code >}} [`semi_latus_rectum_r_e_theta`](/api/exospheres/orbital_mechanics.qmd): $\semiLatusRectum\left(\radius, \eccentricity, \trueAnomaly\right)$: Eq. \eqref{eq:semi_latus_rectum_r_e_theta}  
:::
...
::: {.column-margin}
{{< fa code >}} [`semi_major_axis_r_epskin`](/api/exospheres/orbital_mechanics.qmd): $\semiMajorAxis\left(\radius, \relativeKineticEnergy\right)$: Eq. \eqref{eq:semi_major_axis_r_epskin}  

{{< fa code >}} [`semi_major_axis_r_m_v`](/api/exospheres/orbital_mechanics.qmd): $\semiMajorAxis\left(\radius, \mass, \vec\velocity\right)$: Eq. \eqref{eq:semi_major_axis_r_epskin} with $\relativeKineticEnergy=\relativeKineticEnergy\left(\radius, \mass, \vec\velocity\right)$ and $\velocity_{esc}=\velocity_{esc}\left(\radius, \mass\right)$ of Eqs. \eqref{eq:relative_Ekin_v_vesc} and \eqref{eq:escape_velocity_r_m}

{{< fa code >}} [`semi_major_axis_p_e`](/api/exospheres/orbital_mechanics.qmd): $\semiMajorAxis\left(\semiLatusRectum, \eccentricity\right)$: Eq. \eqref{eq:semi_major_axis_p_e}  

{{< fa code >}} [`semi_major_axis_r_e_theta`](/api/exospheres/orbital_mechanics.qmd): $\semiMajorAxis\left(\radius, \eccentricity, \trueAnomaly\right)$: Eq. \eqref{eq:semi_major_axis_p_e} with $\semiLatusRectum=\semiLatusRectum\left(\radius, \eccentricity, \trueAnomaly\right)$ of Eq. \eqref{eq:semi_latus_rectum_r_e_theta}
:::
...
::: {.column-margin}
{{< fa code >}} [`true_anomaly_r_a_e`](/api/exospheres/orbital_mechanics.qmd): $\trueAnomaly\left(\radius, \semiMajorAxis, \eccentricity\right)$: Eq. \eqref{eq:true_anomaly_r_a_e}  

{{< fa code >}} [`true_anomaly_e_epskin`](/api/exospheres/orbital_mechanics.qmd): $\trueAnomaly\left(\eccentricity, \relativeKineticEnergy\right)$: Eq. \eqref{eq:true_anomaly_e_epskin}  

{{< fa code >}} [`true_anomaly_epskin_v`](/api/exospheres/orbital_mechanics.qmd): $\trueAnomaly\left(\relativeKineticEnergy, \vec\velocity\right)$: Eq. \eqref{eq:true_anomaly_epskin_v}  
:::
...
::: {.column-margin}
{{< fa code >}} [`zenith_angle_v`](/api/exospheres/orbital_mechanics.qmd): $\zenithAngle\left(\vec\velocity\right)$: Eq. \eqref{eq:zenith_angle_v}  
:::
