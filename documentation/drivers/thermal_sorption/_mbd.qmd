...
::: {.callout-tip title="ExESS" collapse=true}
{{< bi code >}} [`velocity_cdf`](/api/base/distributions.qmd): integrated Eq. \eqref{eq:mbd_3d} </br> {{< bi code >}} [`velocity_pdf`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_3d} 
</br> </br> </br> </br>
{{< bi code >}} [`speed_cdf`](/api/base/distributions.qmd): integrated Eq. \eqref{eq:mbd_speed_3d} </br> {{< bi code >}} [`speed_pdf`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_speed_3d} 
:::
...
::: {.callout-tip title="ExESS" collapse=true}
{{< bi code >}} [`elevation_cdf`](/api/base/distributions.qmd): integrated Eq. \eqref{eq:mbd_elevation} </br> {{< bi code >}} [`elevation_pdf`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_elevation} 
:::


{{< include thermal_sorption/imgs/elevation/_mbd_elevation.qmd >}}
...
::: {.callout-tip title="ExESS" collapse=true}
{{< bi code >}} [`speed`](/api/base/distributions.qmd): Eqs. \eqref{eq:mbd_most_probable_speed}, \eqref{eq:mbd_mean_speed}, \eqref{eq:mbd_rms}
:::
...
::: {.callout-tip title="ExESS" collapse=true}
{{< bi code >}} [`velocity`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_random_cartesian_component}
:::
...
::: {.callout-tip title="ExESS" collapse=true}
{{< bi code >}} [`speed`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_speed_random} </br> {{< bi code >}} [`elevation`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_elevation_random} </br> {{< bi code >}} [`azimuth`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_azimuth_random}
:::