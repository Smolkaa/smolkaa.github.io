...
::: {.column-margin}
{{< fa code >}} [`MaxwellBoltzmannVelocityDistribution`](/api/base/distributions.qmd)
:::
...
::: {.column-margin}
{{< fa code >}} [`cdf`](/api/base/distributions.qmd): integrated Eq. \eqref{eq:mbd_speed_3d} </br> {{< fa code >}} [`pdf`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_speed_3d}
:::
...
::: {.column-margin}
{{< fa code >}} [`sample`](/api/base/distributions.qmd): Eq. \eqref{eq:mbd_random_cartesian_component}
:::