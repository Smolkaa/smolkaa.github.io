...
::: {#fig-mbfd_elevation}
![](/documentation/drivers/thermal_sorption/imgs/elevation/mbfd_elevation.svg){width="600px"}

Density plot of $\num{10^{6}}$ normalized samples of a one-directional [MBFD](/documentation/acronyms.qmd) distributed velocities, shown in 2D without the uniform azimuth component. The line shows the mean elevation angle $\meanof{\sphericalCoordinateElevation}$.
:::
...
* {{< downloadthis thermal_sorption/imgs/elevation/mbfd_elevation.pdf label="mbfd_elevation.pdf" type="light" dname="mbfd_elevation" >}} {{< downloadthis thermal_sorption/imgs/elevation/mbfd_elevation.svg label="mbfd_elevation.svg" type="light" dname="mbfd_elevation" >}} 
