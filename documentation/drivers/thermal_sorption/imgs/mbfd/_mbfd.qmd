...
* {{< downloadthis imgs/mbfd/mbfd.pdf label="mbfd.pdf" type="light" dname="mbfd" >}} {{< downloadthis imgs/mbfd/mbfd.svg label="mbfd.svg" type="light" dname="mbfd" >}} {{< downloadthis imgs/mbfd/mbfd.png label="mbfd.png" type="light" dname="mbfd" >}}
