...
::: {.column-margin}
{{< fa code >}} [`MaxwellBoltzmannFluxVelocityDistribution`](/api/base/distributions.qmd)
:::
...
::: {.column-margin}
{{< fa code >}} [`cdf`](/api/base/distributions.qmd): integrated Eq. \eqref{eq:mbfd_speed} </br> {{< fa code >}} [`pdf`](/api/base/distributions.qmd): Eq. \eqref{eq:mbfd_speed}
:::
...
::: {.column-margin}
{{< fa code >}} [`sample`](/api/base/distributions.qmd): Eqs. \eqref{eq:mbd_random_cartesian_component}, \eqref{eq:mbfd_random_cartesian_component}
:::
