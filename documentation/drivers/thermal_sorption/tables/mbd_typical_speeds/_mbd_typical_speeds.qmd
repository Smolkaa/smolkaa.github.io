...
{{< include tables/mbd_typical_speeds/raw_mbd_typical_speeds.md >}}
...
* {{< downloadthis tables/mbd_typical_speeds/raw_mbd_typical_speeds.md label="raw.md" type="light" dname="table" >}}
