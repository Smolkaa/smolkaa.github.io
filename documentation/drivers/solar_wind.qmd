...
\end{equation}
which can be integrated over the angular arguments of the dayside hemisphere, which is $-\pi / 2 \leq \longitude_s \leq \pi / 2$ and $-ß \leq \latitude_s \leq \pi / 2$, to yield the CDF
\begin{equation}
