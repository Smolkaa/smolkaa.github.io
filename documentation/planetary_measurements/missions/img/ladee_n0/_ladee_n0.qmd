...
![(a) Helium surface number densities.](/documentation/planetary_measurements/missions/img/ladee_n0/ladee_n0_He_proj.png)

![(b) Neon surface number densities.](/documentation/planetary_measurements/missions/img/ladee_n0/ladee_n0_Ne_proj.png)

![(c) Argon surface number densities.](/documentation/planetary_measurements/missions/img/ladee_n0/ladee_n0_Ar_proj.png)

Helium (a), neon (b), and argon (c) surface number densities, based on derived data of the LADEE mission and projected to the surface based on @Chamberlain1963 barometric model. The data was taken from the PDS [@LADEE2014]. Gray areas indicate lunar nighttime.
:::
