...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_,           | * analytical model of density distributions in planetary atmospheres/exospheres                                                  |
| _Exosphere_         | * assumes an isothermal, spherically symmetric, and globally uniform atmosphere                                                  |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_,           | * theoretical model of molecular fluxes in the lunar exosphere                                                                   |
| _Exosphere_         | * proposed an analytical framework to calculate elliptical trajectories and the respective landing positions on the Moon         |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Hodges1973         | **"Composition and dynamics of lunar atmosphere"**                                                                               |
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * first $\ce{H2}, \ce{He}, \ce{Ne}$, and $\ce{Ar}$ model of the lunar exosphere                                                  |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_            | * proposed the theory of desorption [velocity distributions](/documentation/drivers/thermal_sorption.qmd)                        |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo model of Mercury's exosphere                                                                                       |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_            | * provides a comprehensive overview of photoreaction rates widely used for modeling the lunar exosphere                          |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Butler1997         | **"The migration of volatiles on the surfaces of Mercury and the Moon"**                                                         |
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_,           | * Monte Carlo exosphere model of Mercury and the Moon, specifically $\ce{H2O}$ and $\ce{CO2}$                                    |
| _Exosphere_         | * proposed an analytic function to approximate the lunar surface temperature                                                     |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo simulation of exospheric hydrogen migration on the Moon                                                            |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo model of the lunar argon exosphere                                                                                 |
|                     | * investigated the accumulation of $\ce{Ar}$ in PSRs                                                                             |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Poppe2013          | **"The self-sputtered contribution to the lunar exosphere"**                                                                     |
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * first self-sputtering model of the lunar exosphere                                                                             |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo model of the lunar argon exosphere, based on @Chaufray2009                                                         |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * Monte Carlo model of solar wind implantation into the lunar surface regolith                                                   |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_            | * presents an analytic approximation of the lunar surface temperatures based on Diviner measurements                             |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * hybrid DSMC approach to investigate water transport in impact-generated lunar atmosphere, combining a continuum description    |
...
|</br></br> **Tags**: | **fractionation, and diffusive barriers"**                                                                                       |
| _Exosphere_         |                                                                                                                                  |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * extension of the previous model [@Farrell2015], presents a formalism to statistically describe hydrogen implantation into the  |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo model (extension of previous model [@Hurley2016]) to investigate spatial distribution of $\ce{H2}$ in the          |
|                     |   lunar exosphere                                                                                                                |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo model of the lunar $\ce{Ar}$ exosphere, based on the works of @Smith1978, @Hodges1973, and @Butler1997             |
|                     | * includes seasonal effects to study long-term variations                                                                        |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Jones2018          | **"Solar wind-induced water cycle on the Moon"**                                                                                 |
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * chemical kinetics model of lunar surficial $\ce{OH}$ and $\ce{H2O}$, investigating the long-term evolution                     |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_,           | * numerical thermal model for a rough lunar surface                                                                              |
| _Surface_           | * extension of @Hurley2015 thermal model                                                                                         |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
...
|</br></br> **Tags**: | **H2 exosphere"**                                                                                                                |
| _Exosphere_         |                                                                                                                                  |
| _Surface_           | * Monte Carlo-based simulation of solar wind implantation into the lunar lunar regolith to study $\ce{H}$ retention and          |
|                     |   implications for the $\ce{H2}$ exosphere                                                                                       |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * reaction kinetics model as an extension of @Farrell2015 and @Farrell2017 Monte Carlo simulation                                |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo simulation of the lunar neon exosphere                                                                             |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * extension of the Monte Carlo model of @Prem2015 to include the influence of radiative heat transfer and shielding of an        |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo simulation of lunar exospheric helium to investigate source rates and thermal accommodation                        |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_,           | * Monte Carlo simulation of the lunar argon exosphere and comparison with [LADEE](/documentation/acronyms.qmd) data              |
| _Exosphere_         | * applied altitude fitting based on @Chamberlain1963 projection model to compare predicted densities with satellite data         |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_,           | * thermodynamical investigation of exospheric densities based on various velocity distributions                                  |
| _Exosphere_         | * provides statistical averaged and exact solutions for short ballistic flights, assuming constant gravitational acceleration    |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Grava2021          | **"Volatiles and refractories in surface-bounded exospheres in the inner solar system"**                                         |
|</br></br> **Tags**: |                                                                                                                                  |
| _Review_,           | * review of exospheric models of surface-bounded exospheres in the inner solar system, focusing on the Moon and Mercury          |
| _Exosphere_         | * considers various volatiles, refractories, ions, and [ENAs](/documentation/acronyms.qmd)                                       |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Jones2021          | **"Thermal evolution of water and hydrogen from Apollo lunar regolith grains"**                                                  |
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * simulated [TPD](/documentation/acronyms.qmd) process and comparison with TPD experiment                                        |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * computer-generated lunar regolith packing to model random walks of argon and water particles to simulate gas transport         |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Review_,           | * review of hydrogen-based exospheric particles and their interaction with their planetary surface                               |
| _Surface_,          | * reports on the status of observations, theory, and laboratory measurements                                                     |
| _Exosphere_         |                                                                                                                                  |
|                     |                                                                                                                                  |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_,          | * Monte Carlo model to investigate $\ce{H}$ implantation, conversion to $\ce{OH}$, and subsequent outgassing of $\ce{H2}$        |
| _Exosphere_         | * simulates the Moon's passage through Earth's magnetotail, eliminating the solar wind proton source, to which the hydrogen      |
...
|</br></br> **Tags**: | **wind implanted lunar volatiles"**                                                                                              |
| _Surface_           |                                                                                                                                  |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * two-part analytic model describing the lunar exospheric neutrals density distributions and the ionization and charged-particle | 
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Theory_,           | * building on @Schoerghofer2020                                                                                                  |
| _Exosphere_         | * provides an analytic description of velocity distributions and exact solutions for emerging density profiles                   |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Wurz2022           | **"Particles and Photons as Drivers for Particle Release from the Surfaces of the Moon and Mercury"**                            |
|</br></br> **Tags**: |                                                                                                                                  |
| _Review_,           | * review of surface interactions of exospheric particles                                                                         |
| _Theory_,           | * includes space weathering, thermal releases, [MMIV](/documentation/acronyms.qmd), [PSD](/documentation/acronyms.qmd) and       |
| _Surface_           |   [ESD](/documentation/acronyms.qmd), physical and chemical sputtering, and particle reflections                                 |
|                     |                                                                                                                                  |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Milillo2023        | **"Future Directions for the Investigation of Surface-Bounded Exospheres in the Inner Solar System"**                            |
|</br></br> **Tags**: |                                                                                                                                  |
| _Review_,           | * review of the current state of knowledge on surface-bounded exospheres in the inner solar system and outline of future         |
| _Exosphere_,        |   research                                                                                                                       |
| _Surface_           | * discussion of various drivers, including solar wind interactions, micrometeoroid impacts, and thermal desorption               |
|                     | * highlights the importance of coordinated space and ground-based observations and discusses expected outcomes                   |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Schoerghofer2023   | **"Past extent of lunar permanently shadowed areas"**                                                                            |
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * discussion the growth of permanently shadowed regions (PSRs) on the Moon                                                       |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Surface_           | * discussion of the adsorption kinetics of water and argon on lunar grains, including multilayer desorption rates, isotherm      |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Exosphere_         | * Monte Carlo simulation framework to simultaneously model multiple hydrogen-based exospheric species                            |
...
|</br></br> **Tags**: |                                                                                                                                  |
| _Review_,           |                                                                                                                                  |
| _Exosphere_,        | * review of descriptions, current developments, and issues of exosphere-surface interactions                                     |
| _Surface_           | * includes discussions of thermal accommodation, volatile diffusion, and cold-trapping                                           |
|                     |                                                                                                                                  |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
