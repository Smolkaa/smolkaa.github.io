...
|                     | * suggests the best description of lunar helium assuming full thermal accommodation and an [MBFD](/documentation/acronyms.qmd)   |
...
|                     |   both on the surface as well as in the exosphere responds quickly                                                               |
...
|                     |                                                                                                                                  |
|{{< kbd REVIEW >}}   | * review of the current state of knowledge on surface-bounded exospheres in the inner solar system and outline of future         |
|{{< kbd EXOSPHERE >}}|   research                                                                                                                       |
|                     | * discussion of various drivers, including solar wind interactions, micrometeoroid impacts, and thermal desorption               |
|{{< kbd SURFACE >}}  | * highlights the importance of coordinated space and ground-based observations and discusses expected outcomes                   |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Schoerghofer2023   | **"Past extent of lunar permanently shadowed areas"**                                                                            |
|                     |                                                                                                                                  |
|{{< kbd SURFACE >}}  | * discussion the growth of permanently shadowed regions (PSRs) on the Moon                                                       |
|                     | * provides an overview of the lunar obliquity and the extent of PSRs as a function of time                                       |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
| @Schoerghofer2023a  | **"Adsorption Kinetics of Water and Argon on Lunar Grain"**                                                                      |
|                     |                                                                                                                                  |
|{{< kbd SURFACE >}}  | * discussion of the adsorption kinetics of water and argon on lunar grains, including multilayer desorption rates, isotherm      |
|                     |   measurements, and the behavior of adsorbate concentrations with                                                                |
|                     | * provides a parameterization of water adsorption intended for a wide range of temperatures and adsorbate concentrations         |
|                     | * emphasizes the significance of understanding the desorption                                                                    |
|                     |                                                                                                                                  |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------+ 
...
\begin{longtable}{@{}p{.25\textwidth} p{.73\textwidth}@{}}
    ...
    \begin{itemize}\setlength\itemsep{-0.7em}
        \item review of the current state of knowledge on surface-bounded exospheres in the inner solar system and outline of future research
        \item discussion of various drivers, including solar wind interactions, micrometeoroid impacts, and thermal desorption
        \item highlights the importance of coordinated space and ground-based observations and discusses expected outcomes
    \end{itemize} \\ \midrule

    \citet{Schoerghofer2023}\newline\emph{Surface} & \textbf{"Past extent of lunar permanently shadowed areas"}
    \begin{itemize}\setlength\itemsep{-0.7em}
        \item discussion the growth of permanently shadowed regions (PSRs) on the Moon
        \item provides an overview of the lunar obliquity and the extent of PSRs as a function of time
    \end{itemize} \\ \midrule

    \citet{Schoerghofer2023a}\newline\emph{Surface} & \textbf{"Adsorption Kinetics of Water and Argon on Lunar Grain"}
    \begin{itemize}\setlength\itemsep{-0.7em}
        \item discussion of the adsorption kinetics of water and argon on lunar grains, including multilayer desorption rates, isotherm measurements, and the behavior of adsorbate concentrations with 
        \item provides a parameterization of water adsorption intended for a wide range of temperatures and adsorbate concentrations
        \item emphasizes the significance of understanding the desorption
    \end{itemize} \\ \midrule
...
Please note that the \LaTeX code above requires the `longtable` and the `mhchem` packages, as well as all necessary references in the bibliography.
