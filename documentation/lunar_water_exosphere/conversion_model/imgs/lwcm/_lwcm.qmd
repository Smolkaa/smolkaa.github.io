...
Lunar water cycle map including most of the known conversion processes between exospheric and surficial, as well as, gaseous and adsorbed, $\ce{H}$, $\ce{H2}$, $\ce{OH}$, and $\ce{H2O}$. _This figure has been published as a research poster on the Lunar and Planetary Science Conference (LPSC), 2023, by A. Smolka._
:::


# {{< fa file-pdf >}} Poster

![](conversion_model/imgs/lwcm/Smolka2023_LPSC_Poster.pdf){width=100% height=920px}
