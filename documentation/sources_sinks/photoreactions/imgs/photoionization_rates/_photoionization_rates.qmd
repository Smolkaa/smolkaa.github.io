...
![](/documentation/sources_sinks/photoreactions/imgs/photoionization_rates/photoionization_rates_BOCHSLER2013.png){width="1200px"}
...
* {{< downloadthis photoreactions/imgs/photoionization_rates/photoionization_rates_BOCHSLER2013.png label="photoionization_rates_BOCHSLER.png" type="light" dname="photoionization_rates_BOCHSLER" >}}  {{< downloadthis photoreactions/imgs/photoionization_rates/photoionization_rates_BOCHSLER2013.pdf label="photoionization_rates_BOCHSLER.pdf" type="light" dname="photoionization_rates_BOCHSLER" >}} 

* {{< downloadthis photoreactions/imgs/photoionization_rates/photoionization_rates_BOCHSLER2013.csv label="data.csv" type="light" dname="data" >}}
